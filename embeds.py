...
help_embed_2.add_field(name='m!playlist [Playlist] / m!pl [Playlist]', value='✧ Spielt die angegebene Playlist ab.', inline=False)
help_embed_2.add_field(name='m!showplaylist [Playlist] / m!spl [Playlist]', value='✧ Zeigt die ersten 10 Titel deiner Playlist an.', inline=False)
help_embed_2.add_field(name='m!showplaylist [Playlist] [Offset] / m!spl [Playlist] [Offset]', value='✧ Zeigt bis zu 10 Titel ab dem [Offset] Titel an.', inline=False)
help_embed_2.add_field(name='m!createplaylist [Playlist] / m!cpl [Playlist]', value='✧ Erstellt eine Playlist mit dem angegebenen Namen.', inline=False)
help_embed_2.add_field(name='m!deleteplaylist [Playlist] / m!dpl [Playlist]', value='✧ Löscht die angegebene Playlist.', inline=False)
help_embed_2.add_field(name='m!playlistadd [Playlist] [Song] / m!pla [Playlist] [Song]', value='✧ Fügt den angegebenen Song zu der Playlist hinzu.', inline=False)
help_embed_2.add_field(name='m!playlistremove [Playlist] [Songindex] / m!plr [Playlist] [Songindex]', value='✧ Entfernt den angegebenen Song von der Playlist.', inline=False)
